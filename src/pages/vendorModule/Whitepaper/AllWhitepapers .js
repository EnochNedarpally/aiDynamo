...
const VendorAllWhitepapers = () => {
 ...
 const Navigate = useNavigate()
  ...
  const fetchCategories=async()=>{
    ...
    const token = "eyJhbGciOiJIUzUxMiJ9.eyJyb2xlcyI6WyJST0xFX1ZFTkRPUiJdLCJzdWIiOiJwYW5rYWouZ2F3YWRlQG9kdGVhbXMuY29tIiwiaWF0IjoxNzMzNzQ4MDgzLCJleHAiOjE3MzQxMDgwODN9.6JxcyUp4LpklVOaNICAeTMpxjDsxITALamot_Osr07WUZUB2AlB6xQY5ifzxWy7kqfwn2YdV-HNldAOSyGBk1Q"
    const config = {
      headers: {
