    ...
    () => [
       ...
       
      {
        ...
        cell: ({ row }) => {
          ...
          // Extract the `id` from the row's data
          ...
          return (
            <div>
              <button
                ...
                onClick={() => handleUnsaved(id)} // Pass the `id` dynamically
              >
                Unsave
              </button>
            </div>
                ...
                <CardBody className="pt-0 ">
                  <div className="flex-grow-1 ">
                    {/* <div className="my-2 mx-1">
                       ...
                       <h4 className="card-title mb-0">Saved Whitepapers List</h4>
...
export default SavedWhitepapers;
...
//   // };
  ...
  const handleAddWhitepapers = () => {
    Navigate('/add-whitepapers'); // Use absolute path instead of relative
  };
