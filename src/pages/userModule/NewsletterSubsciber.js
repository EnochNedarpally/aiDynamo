...
const NewsletterSubsciber = () => {
  return (
    <div className="d-flex " style={{ marginTop: '70px' }}>
      NewsletterSubsciber</div>
  )
}

export default NewsletterSubsciber
...
//                        <h4 className="card-title mb-0">Newsletter Subsciber List</h4>
...
//                         SearchPlaceholder='Search for Newsletter Subsciber...'
//                       />
//                     {/* ) : (<Loader error={error} />)
//                     } */}
//                   </div>
