  ...
  // Column
   ...
   const columns = useMemo(
    () => [
      ...
      {
        header: "WhitePapers Set Category",
        accessorKey: "name",
        enableColumnFilter: false,
      },
                ...
                <CardBody className="pt-0 ">
                  <div className="flex-grow-1 ">
                    {/* <div className="my-2 mx-1">
                       ...
                       <h4 className="card-title mb-0">Category Subsciber List</h4>
                    ...
                    {/* {isCompaniesSuccess && companies.length ? ( */}
                      <TableContainer
                        ...
                        SearchPlaceholder='Search for CategorySubsciber...'
                      />
                    {/* ) : (<Loader error={error} />)
                    } */}
                  </div>
...
export default CategorySubsciber;
