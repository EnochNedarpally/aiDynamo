                ...
                <CardBody className="pt-0 ">
                  <div className="flex-grow-1 ">
                    <div className="my-2 mx-1">
                        ...
                        <h4 className="card-title mb-0 flex-grow-1"> Most Downloaded PDFs</h4>
                    </div>
                    ...
                    {companies?.length ? (
                      <TableContainer
                        ...
                        SearchPlaceholder='Search for PDF...'
                      />
                     ) : (<Loader error={error} />) 
                    } 
                  </div>
...
export default MostDownloadedPDFList;
