...
const AllBlogsCategory = () => {
  ...
  const handleAddCategory = () => {
    Navigate('/add-blogs-category'); // Use absolute path instead of relative
  };
  ...
  <h4 className="card-title mb-0">All Blogs Category</h4>
  <Button 
  color="secondary" 
...
>
  <i className="ri-add-fill me-1 align-bottom"></i> Add Blogs Category
</Button>
                    ...
                    {isCompaniesSuccess && companies.length ? (
                      <TableContainer
                        ...
                        SearchPlaceholder='Search for Blogs Category...'
                      />
                    ) : (<Loader error={error} />)
                    }
                  </div>
