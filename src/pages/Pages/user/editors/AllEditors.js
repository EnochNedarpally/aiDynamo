...
const AllEditors = () => {
  ...
  const columns = useMemo(
    () => [
      ...
      {
        header: "Total NewsLetters",
        accessorKey: "newsletters",
        enableColumnFilter: false,
      },
  ...
  <h4 className="card-title mb-0">All Editors List</h4>
  <Button 
  color="secondary" 
...
>
  <i className="ri-add-fill me-1 align-bottom"></i> Add Editor 
</Button>
                    ...
                    {/* {isCompaniesSuccess && companies.length ? ( */}
                      <TableContainer
                        ...
                        SearchPlaceholder='Search for AllEditors...'
                      />
                    {/* ) : (<Loader error={error} />)
                    } */}
                  </div>
